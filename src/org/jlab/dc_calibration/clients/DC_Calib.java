...
public class DC_Calib extends WindowAdapter implements WindowListener, ActionListener, Runnable {
    ...
    /**
     * This method is for making the textfield popup an edit menu with copy,
     * paste capability when right-clicked on it.
     *
     * @param
     * @return Nothing
    ...
    /**
     * This listner is to trigger the time-to-distance fitter. This sits inside
     * the listener for the file-chooser because until we choose the files to
     * process, the fitter cannot proceed.
     *
     */
    private void addListeners() {
        ...
        if(isLinearFit) System.out.println("You selected Linear Fit.");
        else  System.out.println("You selected Non-Linear Fit.");
